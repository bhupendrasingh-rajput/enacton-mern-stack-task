...
export default async function Products({
  ...
  const { page = 1, pageSize = DEFAULT_PAGE_SIZE, sortBy = "", brandId = "", categoryId, range, gender, occasions, discount } = searchParams as any;

  const { products, count, lastPage, numOfResultsOnCurPage } = await getProducts(
    +page,
    +pageSize,
    sortBy,
    brandId,
